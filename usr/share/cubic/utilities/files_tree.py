...
from utilities.displayer import MONOSPACE_FONT, SOURCE_LANGUAGE, SOURCE_STYLE_SCHEME
...
class FilesTree:
    ...
    def __init__(self, root_file_paths, selection_changed, required_file_paths=None):
        ...
        builder = Gtk.Builder.new_from_file('utilities/tree_view.ui')
    ...
    def create_source_view(self, full_file_path):
        ...
        try:
            ...
            with open(full_file_path, 'r') as file:
                ...
                builder = Gtk.Builder.new_from_file('utilities/source_view.ui')
