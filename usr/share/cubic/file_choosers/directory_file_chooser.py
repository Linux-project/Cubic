...
def on_clicked__directory_file_chooser__cancel_button(widget):
    logger.log_title('Clicked directory file chooser cancel button')
    close()


def on_clicked__directory_file_chooser__select_button(widget):
    logger.log_title('Clicked directory file chooser select button')
    close()
...
def on_delete_event__directory_file_chooser(widget, event):
    logger.log_title('Delete directory file chooser')
    close()
    return True
